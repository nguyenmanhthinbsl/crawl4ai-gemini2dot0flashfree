...
async def get_job_info(data, url):
    ...
    # {{
    #     "jobname": "$Tên Việc Làm đang được giới thiệu ở trang web này",
    #     "companyname": "$Tên Công ty đang được giới thiệu ở trang web này",
    #     "url": "$URL href (của công việc đó)",
    #     "expired": "$Thời gian hiệu lực của công việc đang tuyển dụng đó"
    #     "contact": "$Thông tin liên hệ của công ty tuyển dụng là số điện thoại hoặc email nếu có"
    # }}
    # """
...
async def main(): 
    ...
    async with AsyncWebCrawler(config=browser_config) as crawler:
        urls = [
            "https://www.topcv.vn/tim-viec-lam-it-support-tai-binh-duong-kl3?sba=1&locations=l3",
            "https://careerviet.vn/viec-lam/it-tai-binh-duong-kl650-vi.html",
            "https://www.vietnamworks.com/viec-lam?q=it&l=11",
            #"https://vn.indeed.com/jobs?q=it&l=B%C3%ACnh+D%C6%B0%C6%A1ng&from=searchOnHP%2Cwhereautocomplete&vjk=d110fd014c9f4c77",
            "https://jobsgo.vn/viec-lam-cong-nghe-thong-tin-tai-binh-duong.html",
            "https://www.jobstreet.vn/j?sp=homepage&trigger_source=homepage&q=it&l=B%C3%ACnh+D%C6%B0%C6%A1ng",
        ]
